...
public class fragment_covid19 extends Fragment {
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle saveInstanceState) {
        View view = layoutInflater.inflate(R.layout.fragment_covid19, container, false);
        MainActivity activity = (MainActivity) getActivity();
        ImageView back_button = view.findViewById(R.id.covid_back_button);
        ImageView go_setting = view.findViewById(R.id.covid_go_setting);
