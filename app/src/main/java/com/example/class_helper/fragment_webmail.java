...
public class fragment_webmail extends Fragment {
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle saveInstanceState) {
        View view = layoutInflater.inflate(R.layout.fragment_webmail, container, false);
        MainActivity activity = (MainActivity) getActivity();
        ImageView back_button = view.findViewById(R.id.mail_back_button);
        ImageView go_setting = view.findViewById(R.id.mail_go_setting);
