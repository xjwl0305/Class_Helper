...
public class fragment_notice extends Fragment {
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle saveInstanceState) {
        View view = layoutInflater.inflate(R.layout.fragment_notice, container, false);
        MainActivity activity = (MainActivity) getActivity();
        ImageView back_button = view.findViewById(R.id.noti_back_button);
        ImageView go_setting = view.findViewById(R.id.noti_go_setting);
